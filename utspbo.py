...
Titania_rek=Saldo_umum("170411100014", 100000)
#Output Rekening Tabungan
Tania_rek=Saldo_tabungan("170411100014", 100000)
#Output Menu Kedua
    ...
    while loop == "y" and status_login == True:
        ...
        if a == 1:
           #Output Informasi Saldo Umum dan Tabungan
            Titania_rek.cek_saldou()
            Tania_rek.cek_saldot()
            loop = "n"
        elif a == 2:
            #menu kedua
